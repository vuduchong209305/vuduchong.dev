...
<head>
	...
	<link rel="shortcut icon" href="/assets/admin/images/favicon/favicon-1000x1000.png">
					...
					<div class="login-container">
						<div class="center">
							<h1>
								...
								<span class="white" id="id-text2">VuDucHong</span>
							</h1>
							<h4 class="blue" id="id-company-text">&copy; Hong Vu Duc Co,.Ltd</h4>
						</div>

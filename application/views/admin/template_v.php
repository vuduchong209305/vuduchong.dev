...
<head>
	...
	<link rel="shortcut icon" href="/assets/admin/images/favicon/favicon.png">
	...
	<script src="/assets/admin/js/moment.locale.js"></script>
	...
	<div id="navbar" class="navbar navbar-default ace-save-state">
		<div class="navbar-container ace-save-state" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				<a href="/admin/calendar" class="navbar-brand">
					<small>
				...
				<ul class="nav ace-nav">
								...
								<ul class="dropdown-menu dropdown-navbar">
									<li>
										<a href="#" class="clearfix">
											<img src="/assets/admin/images/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
											<span class="msg-body">
									...
									<li>
										<a href="#" class="clearfix">
											<img src="/assets/admin/images/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
											<span class="msg-body">
												<span class="msg-title">
									...
									<li>
										<a href="#" class="clearfix">
											<img src="/assets/admin/images/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
											<span class="msg-body">
												<span class="msg-title">
									...
									<li>
										<a href="#" class="clearfix">
											<img src="/assets/admin/images/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
											<span class="msg-body">
												<span class="msg-title">
									...
									<li>
										<a href="#" class="clearfix">
											<img src="/assets/admin/images/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" />
											<span class="msg-body">
												<span class="msg-title">
					...
					<li class="light-blue dropdown-modal">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="<?php echo $this->avatar_path ? $this->avatar_path : '/assets/admin/images/no_image.png' ?>" alt="Jason's Photo" />
			...
			<ul class="nav nav-list">
				<li class="active">
					<a href="/admin/calendar">
						...
						<span class="menu-text"> Lịch của tôi </span>
					</a>
					<b class="arrow"></b>
				</li>
				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<?php echo $this->data_admin['main_content'];?>
